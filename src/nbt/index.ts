...
import MappedBlockStates from './mapped_block_states.json';
...
const MAPPED_BLOCK_STATES = Buffer.from(MappedBlockStates as number[]);

export { CANONICAL_BLOCK_STATES, BIOME_DEFINITION_LIST, MAPPED_BLOCK_STATES };
